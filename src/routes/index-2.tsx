...
import heroFallback from "@/assets/hero-vn.jpg";
import imgHcm from "@/assets/card-hcm.jpg";
import imgDoclap from "@/assets/card-doclap.jpg";
import imgDbp from "@/assets/card-dbp.jpg";
import imgGiap from "@/assets/card-giap.jpg";
import img1975 from "@/assets/card-1975.jpg";
import imgQuocky from "@/assets/card-quocky.jpg";
import imgVanhoa from "@/assets/card-vanhoa.jpg";
import imgThanhnien from "@/assets/card-thanhnien.jpg";
import imgHanoi from "@/assets/card-hanoi.jpg";
import imgSaigon from "@/assets/card-saigon.jpg";
import imgNhandan from "@/assets/card-nhandan.jpg";
...
const HERO_REAL = wiki("National flag of Vietnam in Hanoi 24-12-2016.jpg", 1600);
...
const dungNuoc: StoryItem[] = [
  ...
  },
  {
    ...
    image: wiki("Hai Ba Trung Tem Su.jpg"),
    fallback: imgGiap,
    story:
  ...
  },
  {
    ...
    image: wiki("Ly Thuong Kiet (1019-1105) Defeated Song China Invasion of 1077 (9732106811).jpg"),
    fallback: imgGiap,
    story:
  ...
  },
  {
    ...
    image: wiki("Tran Hung Dao (1129-1300) Defeated Mongol Invasion at Bach Dang, 1288 (9732105763).jpg"),
    fallback: imgDbp,
    story:
...
// Sắp xếp theo trình tự thời gian: nhân vật (theo năm sinh) → sự kiện (theo năm xảy ra)
const cachMang: StoryItem[] = [
  ...
  },
  {
    ...
    image: wiki("Vietnam-Cach mang thang 8-1945-Mit tinh tai Quang truong Nha hat lon Ha Noi.jpg"),
    fallback: imgDoclap,
    story:
  ...
  },
  {
    ...
    sources: [
      { label: "Wikipedia tiếng Việt — Tuyên ngôn Độc lập (Việt Nam Dân chủ Cộng hoà)", url: wp("Tuy%C3%AAn_ng%C3%B4n_%C4%91%E1%BB%99c_l%E1%BA%ADp_(Vi%E1%BB%87t_Nam_D%C3%A2n_ch%E1%BB%A7_C%E1%BB%99ng_h%C3%B2a)") },
    ],
  },
  {
    category: "Thời đại Hồ Chí Minh",
    ...
    image: wiki("Flag of Vietnam.svg", 1200),
    fallback: imgQuocky,
    story:
      "Lá cờ đỏ sao vàng năm cánh xuất hiện lần đầu trong cuộc Khởi nghĩa Nam Kỳ tháng 11/1940. Tác giả mẫu cờ theo nhiều nguồn nghiên cứu là đồng chí Nguyễn Hữu Tiến (1901–1941), tuy nhiên vẫn còn ý kiến cho rằng người vẽ là Lê Quang Sô.\n\nNgày 5/9/1945, Chủ tịch Hồ Chí Minh ký Sắc lệnh quy định Quốc kỳ Việt Nam là “lá cờ đỏ, ở giữa có sao vàng năm cánh”. Quốc hội khoá I (kỳ họp thứ hai, tháng 3/1946) đã chính thức công nhận. Sau khi đất nước thống nhất, Quốc hội khoá VI ngày 2/7/1976 tiếp tục xác định đây là Quốc kỳ của nước Cộng hoà Xã hội chủ nghĩa Việt Nam.\n\nNền đỏ tượng trưng cho cách mạng và máu của các anh hùng liệt sĩ. Ngôi sao vàng đại diện cho linh hồn dân tộc và khối đại đoàn kết toàn dân.",
    sources: [
  ...
  },
  {
    ...
    fallback: img1975,
    story:
      "Cuộc Tổng tiến công và nổi dậy mùa Xuân 1975 gồm ba chiến dịch lớn: Tây Nguyên (4 – 24/3), Huế – Đà Nẵng (21 – 29/3) và Chiến dịch Hồ Chí Minh (26 – 30/4).\n\nTrưa 30/4/1975, các xe tăng của Lữ đoàn xe tăng 203 tiến vào Dinh Độc Lập. Theo tư liệu hiện hành, xe tăng 390 (kíp xe: Vũ Đăng Toàn, Nguyễn Văn Tập, Ngô Sỹ Nguyên, Lê Văn Phượng) húc đổ cánh cổng chính, còn Trung uý Bùi Quang Thận trên xe tăng 843 lên nóc Dinh kéo cờ Mặt trận Dân tộc Giải phóng miền Nam Việt Nam. Vai trò cụ thể của hai kíp xe từng là chủ đề tranh luận trong nhiều năm.\n\nTổng thống Dương Văn Minh tuyên bố đầu hàng vô điều kiện. Sau 21 năm chia cắt, đất nước thống nhất, Bắc – Nam thu về một mối.",
    sources: [
...
// ============== VĂN HOÁ & DI SẢN ==============
// Sắp xếp theo trình tự thời gian xuất hiện / hình thành
const vanHoa: StoryItem[] = [
  {
    category: "Văn hoá & Di sản",
    title: "Vịnh Hạ Long",
    date: "Hình thành ~500 triệu năm — UNESCO 1994 & 2000",
  ...
  },
  {
    ...
    fallback: imgVanhoa,
    story:
      "Văn Miếu được xây dựng năm 1070 dưới triều vua Lý Thánh Tông để thờ Khổng Tử và các bậc tiên thánh, tiên hiền của đạo Nho. Năm 1076, vua Lý Nhân Tông cho lập Quốc Tử Giám bên cạnh — được xem là trường đại học đầu tiên của Việt Nam, ban đầu dành cho con vua và quan lại, sau mở rộng cho học trò ưu tú trong cả nước.\n\nTrong gần một nghìn năm, các triều Lý, Trần, Lê, Mạc, Nguyễn đã tổ chức nhiều khoa thi tại đây. 82 tấm bia tiến sĩ bằng đá khắc tên 1.304 vị đỗ đại khoa từ năm 1442 đến 1779 còn lưu giữ tới ngày nay.\n\nNăm 2010, 82 bia tiến sĩ đã được UNESCO công nhận là Di sản tư liệu thế giới thuộc Chương trình Ký ức Thế giới.",
    sources: [
      ...
      { label: "UNESCO — Stone Stele Records of Royal Examinations", url: "https://en.unesco.org/memoryoftheworld/registry/162" },
    ],
  },
  {
    category: "Văn hoá & Di sản",
    ...
    image: wiki("Saigon Notre-Dame Basilica, Ho Chi Minh City, Vietnam.jpg"),
    fallback: imgSaigon,
    story:
      ...
      <div className="relative">
        ...
        >
          {items.map((card, i) => (
            <div
              key={card.title}
              className="snap-start shrink-0 w-[78vw] sm:w-[340px] md:w-[300px] lg:w-[320px]"
            >
              <HistoryCard
                index={i}
                title={card.title}
...
function Index() {
  ...
  const [heroSrc, setHeroSrc] = useState(HERO_REAL);
  ...
  return (
    <main className="relative min-h-screen bg-[#050505] text-foreground">
      <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 opacity-[0.07]"
        style={{ backgroundImage: `url(${heroFallback})`, backgroundSize: "cover", backgroundPosition: "center", filter: "blur(40px) saturate(1.4)" }}
      />
      ...
      <section ref={heroRef} className="relative h-[100svh] min-h-[680px] w-full overflow-hidden">
        <motion.div style={{ y: heroY, scale: heroScale, opacity: heroOpacity }} className="absolute inset-0">
          <img
            ...
            onError={() => heroSrc !== heroFallback && setHeroSrc(heroFallback)}
